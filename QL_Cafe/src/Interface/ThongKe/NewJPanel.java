...
import static Interface.ThongKe.NewJFrame.mySqlConnectt;
...
public class NewJPanel extends javax.swing.JPanel {
     ...
     */
    public NewJPanel() throws JRException, ClassNotFoundException, SQLException {
        initComponents();
        ShowReport();
    }
    ...
    public static Connection mySqlConnectt() throws ClassNotFoundException, SQLException {
     ...
     private void ShowReport() throws JRException, ClassNotFoundException, SQLException{
        ...
        try {
            String link = "src\\Interface\\ThongKe\\report.jrxml";
